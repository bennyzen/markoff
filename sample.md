...
[github.com/bennyzen/markoff](https://github.com/bennyzen/markoff)
...
This is **bold text**, _italic text_, ~~strikethrough~~, `inline code`, and a [link](https://github.com/getmarkoff/markoff).
...
**markoff** uses **lazy loading** for syntax highlighting to keep the app fast and lightweight:
